...
def data_augmentation_spacy(df):
    ...
    df['Assignment_Group_Updated'][801:1600] = "GRP_01"
    df['Assignment_Group_Updated'][1601:2400] = "GRP_02"
    df['Assignment_Group_Updated'][2401:3200] = "GRP_03"
    df['Assignment_Group_Updated'][3201:3934] = "GRP_04"

    print(df['Assignment_Group_Updated'].value_counts())

    df['Description_updated'] = df['Short description'].apply(str) + df['Description'].apply(str)
